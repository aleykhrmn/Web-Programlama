...
import net.javaguides.usermanagement.dao.UsersDao;
...
public class UsersServlet extends HttpServlet {
	...
	private void listUser(HttpServletRequest request, HttpServletResponse response)
		...
		List<Users> listUsers = usersDao.selectAllUsers();
	...
	private void showEditForm(HttpServletRequest request, HttpServletResponse response)
		...
		Users existingUsers = usersDao.selectUsers(id);
		RequestDispatcher dispatcher = request.getRequestDispatcher("users-form.jsp");
	...
	private void insertUser(HttpServletRequest request, HttpServletResponse response) 
		...
		Users newUsers = new Users(name, email, country);
		usersDao.insertUsers(newUsers);
